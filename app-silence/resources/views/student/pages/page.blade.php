...
<body style="background: #FFF;">
    <div id="app" style="padding: 0; background-color: #464d80; display:flex; flex-direction:column;">
        ...
        <div style="display: flex; flex-grow: 1;">
            ...
            <div style="flex-grow:1; display:flex; flex-direction:column; padding: 0 16px 0 32px; background: {{ $contentBackground }}; overflow-y: scroll;">
  ...
  window.intercomSettings = {
    ...
    app_id: "pdecq750", 
    ido_gar: <?php echo json_encode(Auth::user()->ido_gar) ?>,  
    profil_gar: <?php echo json_encode(Auth::user()->profil_gar) ?>, 
    etablissement_gar: <?php echo json_encode(Auth::user()->etablissement_gar) ?>, 
    classe_gar: <?php echo json_encode(Auth::user()->classe_gar) ?>, 
