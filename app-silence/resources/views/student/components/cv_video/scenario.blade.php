...
<div id="scenario-container" class="d-flex flex-column h-100">
                ...
                <div class="personnages-container">
                    ...
                    <div class="add-existing-personnage-sequence">
                        <select class="personnage-select form-control">
                            <option value="" disabled selected>Selectionne un personnage</option>
                        </select>
                        <button type="button" class="btn btn-primary add-personnage-btn">
                            <i class="fas fa-plus-circle" style="color: white;"></i>
                        </button>
            ...
            @foreach ($scenario->sequences as $sequence)
                ...
                <div id="sequence-{{ $index }}" class="sequence-scenario-container">
                    ...
                    <div class="personnages-container">
                        ...
                        <div class="add-new-personnage-sequence">
                            <input type="text" class="form-control add-personnage-input"
                        ...
                        <div class="liste-personnages">
                            @foreach (getSequencePersonnages($sequence) as $personnage)
                                @if ($personnage !== 'Selectionne un personnage')
                                    <div class="liste-personnage-item">
                                        <button type="button" class="btn btn-outline-primary">
                                            <span>{{ $personnage }}</span>
                                        </button>
                    ...
                    <div class="dialogues-descriptions">
                        @foreach ($sequence->dialogues_descriptions as $keyIndex => $dialogue_description)
                            @php
                                $isLastItem = $keyIndex === count($sequence->dialogues_descriptions) - 1;
                            @endphp
                            ...
                            @elseif ($dialogue_description->type == 'dialogue')
                                <div class="personnage-dialogue">
                                    <select name="personnage" class="personnage-select form-control"
                                        style="width:400px;">
                                        <option disabled selected>Selectionne un personnage</option>
                                        {!! buildSequencePersonnagesOptions($scenario->personnages, $dialogue_description->value->personnage ?? '') !!}
                                    </select>
                               <div class="peros-dialogue">
                                    
                                                   <input type="hidden" class="perso form-control" style="margin: 0px 16px;"
                                        placeholder="perso"
                                        value="{{ $dialogue_description->value->personnage ?? '' }}">
                                  </div>
                                                                    @if ($dialogue_description->value->personnage == $dialogue_description->value->emotion)
                                    <input type="text" class="emotion form-control" style="margin: 0px 16px;"
                                        placeholder="Emotion"
                                        value="">
                                  @else
                                        <input type="text" class="emotion form-control" style="margin: 0px 16px;"
                                        placeholder="Emotion"
                                        value="{{ $dialogue_description->value->emotion ?? '' }}">
                                  @endif
                    ...
                    <ul class="nav nav-pills mb-1" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                ...
                                aria-controls="pills-home" aria-selected="true">Modifier le personnage</button>
                        </li>
                        <li class="nav-item" role="presentation">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <div class="modal-body">
                            Veuillez entrer le nouveau nom de "<span class="nom_personnage fw-bold"></span>" et cliquer
                            sur enregistrer
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-success" data-bs-dismiss="modal"
                                onclick="editPersonnage()">Enregistrer</button>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                        ...
                        <div class="modal-body">
                            <p>
                                Supprimer le personnage "<span
                                    class="nom_personnage fw-bold"></span>" ? <br />
                                <b>Supprimer un personnage du scénario entraînera la suppression de tous ses dialogues dans le scénario.</b>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal"
                                onclick="deletePersonnage()">Supprimer</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Supprimer le personnage <span id="personnage-delete"
                            style="font-weight: bold;"></span> ?</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Supprimer un personnage de la séquence entraînera la suppression de tous ses dialogues dans la séquence.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal"
    ...
    <div id="delete-sequence-confirm-modal" class="modal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Supprimer séquence</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Supprimer la séquence ?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
    ...
    <div id="delete-dialogue-confirm-modal" class="modal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Supprimer dialogue</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Supprimer ce dialogue ?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
    ...
    <div id="delete-description-confirm-modal" class="modal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Supprimer  description</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Supprimer cette description ?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                    <button type="button" class="btn btn-danger">Supprimer</button>
