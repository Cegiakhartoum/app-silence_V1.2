...
function getOrangePopoverContent($index)
{
    switch ($index) {
        ...
        case 5:
            return "Note la ou les prises que  <br/>
            tu veux utiliser pour le montage.
            ";
        ...
        case 9:
            ...
            case 10:
                return "Désigne l enregistrement d un <br/>
                plan lors du tournage. Tu peux réaliser <br/> 
                plusieurs prises pour tous tes plans et <br/> 
                séquences, jusqu à l obtention d un résultat <br/>
                satisfaisant pour le réalisateur.<br/>
				";
