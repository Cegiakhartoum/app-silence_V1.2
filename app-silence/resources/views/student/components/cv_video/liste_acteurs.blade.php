                    ...
                    <input type="hidden" class="form-control" style=" width:100%;"
                            ...
                            <td>
                                <input type="text" class="form-control" style=" width:100%;"
                                    placeholder="prénom" name="prenom_acteur[]" value="{{ $arr["prenom"] }}"></td>
                            ...
                            <td><input type="email" class="form-control" style=" width:100%;"
                                    placeholder="e-mail" name="mail_acteur[]" value="{{ $arr["mails"] }}"></td>
                            <td><input type="tel" class="form-control" style=" width:100%;"
                                    placeholder="téléphone" name="telephone_acteur[]" value="{{ $arr["telephones"] }}"></td>
