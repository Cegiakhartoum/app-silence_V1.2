@extends('productrice.layouts.page-atelier', ['contentBackground' => '#161c30'])

@section('sidebar')
    <div>
        <a href="/distributeur/parcours-film-fiction">
    ...
    <div>
        <a href="/distributeur/atelier-schema-narratif-recap">
