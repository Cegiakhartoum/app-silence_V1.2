 ...
 <div id="open-modal-archive{{ $projetAction['id'] }}" class="modal-window" >
     <div>
            ...
            <form id="action-form" class="flex-grow-1" method="GET" action="/archive/1/{{ $projetAction['id'] }}" style="text-align:center;">
                @csrf
                  <p style="color:black;">  Etes vous sur de vouloir archivé le projet : {{ $projetAction['nom'] }} ? </p>
                    <br>
 ...
 <div id="open-modal-delete{{ $projetAction['id'] }}" class="modal-window" >
     <div>
            ...
            <form id="action-form" class="flex-grow-1" method="GET" action="/delete/{{ $projetAction['id'] }}" style="text-align:center;">
                @csrf
                  <p style="color:black;">  Etes vous sur de vouloir suprimer le projet : {{ $projetAction['nom'] }} ? </p>
                    <br>
...
<div class="d-flex flex-column stat-box" style="background:#2d314b;color:#b9b9ba;margin-left:5%;">
    <table>
         <tr>
            <td>
                <p style="color: #d5972b;text-align:left;">Les projet(s) en cours </p> <br>
                <H3 style="color:white;text-align:left;">Les préparation <br>de tournage</H3>
...
<!-- End The Modal -->
        ...
        @endforeach
        @php var_dump($projetActionCtrl->findProjetsGroupStudentTournage(Auth::user()->id))@endphp
