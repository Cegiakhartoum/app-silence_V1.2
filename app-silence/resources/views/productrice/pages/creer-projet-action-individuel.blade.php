        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content pb-2" style="background: #3c3d5f;">
                <div class="modal-body text-white">
                    ...
                    <form method="POST" action="/distributeur/student-create">
                        @csrf
                    ...
                    <div class="modal-body text-white">
                        ...
                        <div class="text-end">
                            <a class="btn btn-orange btn-lg rounded-3"
                                href="/distributeur/action?c=0&p={{ request()->input('p') }}" style="margin-right: 48px;">Je
                                passe à l'ACTION!</a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="background-color: #4a4d77;">
                ...
                <form method="POST" action="ateliers/create">
                        <input type="hidden" name="redirect_url" value="/student/ateliers" />
                        <input type="hidden" name="owner_type" value="student" />
                        <input type="hidden" name="classe" value="classe 1" />
