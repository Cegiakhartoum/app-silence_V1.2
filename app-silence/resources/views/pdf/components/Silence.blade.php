    ...
    <div class="page-cover">
        ...
        <div style="font-size: 12pt;">
            ...
            <div id="scenario-container" class="d-flex flex-column h-100">
                ...
                <div id="sequences">
                    ...
                    <br><br>
                    <pre style="white-space: pre-wrap; font-family: 'Ubuntu', sans-serif;">{{ $action->thematique }}</pre>
        ...
        <div style="font-size: 12pt;">
            ...
            <div id="scenario-container" class="d-flex flex-column h-100">
                ...
                <div id="sequences">
                    ...
                    <br><br>
                             <pre style="white-space: pre-wrap; font-family: 'Ubuntu', sans-serif;"> {{ $action->pitch }}</pre>
            ...
            <div id="scenario-container" class="d-flex flex-column h-100">
                ...
                <div id="sequences">
                    ...
                    <td style="font-size: 12pt;">
                        ...
                        <td style="font-size: 12pt;">
                                 <pre style="white-space: pre-wrap; font-family: 'Ubuntu', sans-serif;"> {{ $action->situtation_initiale ?? '' }}</pre>
                        </td>
                    </tr>
                    <tr>
                    <td style="font-size: 12pt;">
                        ...
                        <td style="font-size: 12pt;">
                                 <pre style="white-space: pre-wrap; font-family: 'Ubuntu', sans-serif;">     {{ $action->element_pertubateur ?? '' }} </pre>
                        </td>
                    </tr>
                    <tr>
                    <td style="font-size: 12pt;">
                        ...
                        <td>
                                 <pre style="white-space: pre-wrap; font-family: 'Ubuntu', sans-serif;">  {{ $action->peripeties ?? '' }} </pre>
                        </td>
                    </tr>
                    <tr>
                    <td style="font-size: 12pt;">
                        ...
                        <td style="font-size: 12pt;">
                                 <pre style="white-space: pre-wrap; font-family: 'Ubuntu', sans-serif;"> {{ $action->element_resolution ?? '' }}</pre>
                        </td>
                    </tr>
                    <tr>
                    <td style="font-size: 12pt;">
                        ...
                        <td style="font-size: 12pt;">
                                 <pre style="white-space: pre-wrap; font-family: 'Ubuntu', sans-serif;"> {{ $action->situation_finale ?? '' }} </pre>
                        </td>
                 </tr>
    </table>
        ...
        <div style="font-size: 12pt;">
            ...
            <div id="scenario-container" class="d-flex flex-column h-100">
                ...
                <br><br>
                             <pre style="white-space: pre-wrap; font-family: 'Ubuntu', sans-serif;"> {{ $action->synopsis }} </pre>
        ...
        <div style="font-size: 12pt;">
            ...
            <div id="scenario-container" class="d-flex flex-column h-100">
                ...
                <br><br>
                <pre style="white-space: pre-wrap; font-family: 'Ubuntu', sans-serif;">{{ $action->traitement }}</pre>
...
<div style="font-size: 12pt;">
    <div id="scenario-container" class="d-flex flex-column h-100">
        <div id="sequences">
            ...
            <table>
                <tr>
                    <td style="width:10%;">SÉQ N° </td>
                    <td style="width:25%;">DÉCOR</td>
                    <td>LIEU </td>
                    <td style="width:15%;">JOUR DE TOURNAGE </td>
                </tr>
                @php
                    $sequenceIds = [];
                @endphp
                    ...
                    <tr>
                        <td>
                            @foreach ($decoupages_s as $decoupag)
                                @if ($decoupag->lieu == $decoupage->lieu && !in_array($decoupag->sequence_id, $sequenceIds))
                                    {{ $decoupag->sequence_id }}
                                    @php
                                        $sequenceIds[] = $decoupag->sequence_id;
                                    @endphp
                                @endif
                            @endforeach
                        </td>
                        ...
                        @foreach ($decoupages_s as $decoupag)
                            @if ($t < 1)
                                @if ($decoupag->lieu == $decoupage->lieu)
                                    <td>{{ $decoupag->decors }}</td>
                                    <td>{{ $decoupag->jours }}</td>
                                    @php
                                        $t++;
                                    @endphp
                                @endif
    ...
    <div style="font-size: 12pt;">
        <div id="scenario-container" class="d-flex flex-column h-100">
            <div id="sequences">
                ...
                <table>
                    <tr>
                        <td style="width:10%;">Personnage</td>
                        <td style="width:25%;">Prenom</td>
                        <td>Nom</td>
                        <td style="width:15%;">Mails</td>
                        <td style="width:15%;">Telephone</td>
                    </tr>
                    @foreach ($liste_acteurs as $liste_acteur)
                        <tr>
                            <td style="width:10%;">{{ $liste_acteur->personnages }}</td>
                            <td style="width:25%;">{{ $liste_acteur->prenom }}</td>
                            <td>{{ $liste_acteur->nom }}</td>
                            <td style="width:15%;">{{ $liste_acteur->mails }}</td>
                            <td style="width:15%;">{{ $liste_acteur->telephones }}</td>
                        </tr>
                    @endforeach
                </table>
            </div>
